...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='listing',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.listing'),
        ),
        migrations.AddField(
            model_name='orderitem',
            name='order',
        ...
        migrations.AddField(
            ...
            name='listing',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='claims', to='inventory.listing'),
        ),
        migrations.AddField(
            model_name='wasteclaim',
            name='user',
