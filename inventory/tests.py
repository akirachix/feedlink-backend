...
class ListingModelTest(TestCase):
    ...
    def test_create_listing_with_producer(self):
        """Test that a listing can be created with a producer user."""
    ...
    def test_listing_requires_producer_role(self):
        """Test that only users with role 'producer' can be assigned as producer."""
    ...
    def test_expiry_date_can_be_null(self):
        """Test that expiry_date can be blank/null for inedible products."""
        listing = Listing.objects.create(
            producer=self.producer,
            product_type='inedible',
            quantity=Decimal('5.00'),
    ...
    def test_required_fields(self):
        """Test that required fields without defaults raise validation errors if missing."""
        with self.assertRaises(ValidationError):
            listing = Listing(
                producer=self.producer,
                quantity=Decimal('5.00'),
    ...
    def test_choices_validation(self):
        """Test that invalid choices for CharField choices raise ValidationError."""
        with self.assertRaises(ValidationError):
            listing = Listing(
                producer=self.producer,
    ...
    def test_image_and_image_url_optional(self):
        """Test that image and image_url are optional."""
        listing = Listing.objects.create(
            producer=self.producer,
            product_type='edible',
            quantity=Decimal('5.00'),
    ...
    def test_original_and_discounted_price_optional(self):
        """Test that pricing fields are optional."""
        listing = Listing.objects.create(
            producer=self.producer,
            product_type='edible',
            quantity=Decimal('5.00'),
    ...
    def test_category_and_description_optional(self):
        """Test that category and description are optional."""
        listing = Listing.objects.create(
            producer=self.producer,
            product_type='edible',
            quantity=Decimal('5.00'),
    ...
    def test_listing_id_auto_increment(self):
        """Test that listing_id is auto-incremented primary key."""
    ...
    def test_pickup_window_duration_required(self):
        """Test that pickup_window_duration is required."""
        with self.assertRaises(ValidationError):
            listing = Listing(
                producer=self.producer,
                product_type='edible',
    ...
    def test_quantity_positive(self):
        """Test that quantity must be positive (implicitly, since DecimalField doesn't enforce >0)."""
        listing = Listing.objects.create(
            producer=self.producer,
            product_type='edible',
